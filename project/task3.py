...
def intersect_automata(
    ...
    for sym, adj1 in mfa1.adj_matrix.items():
        ...
        intersection.adj_matrix[sym] = kron(adj1, adj2, format=sparse_format([[]]).getformat())
...
def tensor_based_rpq(
    ...
    graph_mfa = AdjacencyMatrixFA(graph_to_nfa(graph, start_nodes, final_nodes), sparse_format)
